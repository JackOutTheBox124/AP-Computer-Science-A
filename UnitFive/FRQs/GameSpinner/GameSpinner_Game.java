      ...
      while (!escape && wallet >= 0){
         ...
         switch (spinner){
            ...
            case 1:
               s1.spin();
               if (s1.getValue() % 2 == 1){
                  System.out.println("You Spun a " + s1.getValue() + " You Lose " + df2.format((((100 * ((s1.getValue() + 1)/2)) + 10)  - (10 * mult))) + " buckaroos");
                  wallet = wallet - (((100 * ((s1.getValue() + 1)/2)) + 10)  - (10 * mult));
               }
               if (s1.getValue() % 2 == 0){
                  System.out.println("You Spun a " + s1.getValue() + " You Won " + df2.format(((100 * (s1.getValue() / 2)) * mult)) + "buckaroos");
            ...
            case 2:
               ...
               if (s1.getValue() % 2 == 1){
                  System.out.println("You Spun a " + s2.getValue() + " You Lose " + df2.format((((100 * ((s2.getValue() + 1)/2)) + 10)  - (10 * mult))) + " buckaroos");
                  wallet = wallet - (((100 * ((s2.getValue() + 1)/2)) + 10)  - (10 * mult));
               }
               if (s1.getValue() % 2 == 0){
                  System.out.println("You Spun a " + s2.getValue() + " You Won " + df2.format(((100 * (s2.getValue() / 2)) * mult)) + "buckaroos");
            ...
            case 3:
               ...
               if (s1.getValue() == s2.getValue() && s2.getValue() == s3.getValue()){
                  System.out.println("JACKPOT! \n YOU WON: " + df2.format(1000 * mult) + " Buckaroos");
                  wallet = wallet + Integer.parseInt(df2.format(1000 * mult));
               }
               else if (s1.getValue() == s2.getValue() || s2.getValue() == s3.getValue() || s3.getValue() == s1.getValue()){
                  System.out.println("DOUBLE!");
                  wallet = wallet + Integer.parseInt(df2.format(250 * mult));
               }
               else {
            ...
            case 4:
               ...
               if (s1.getValue() % 2 == 1){
                  ...
                  wallet = wallet + Integer.parseInt(df2.format(500 * mult));
               }
               if (s1.getValue() % 2 == 0){
            ...
            case 6:
               s1.spin();
               System.out.println("MyStErY wHeEl:");
               if (s1.getValue() == 1){
